...
Drupal.behaviors.stylestrap_vertical_tabs = {
...
Drupal.behaviors.stylestrap_buttons = {
  attach:function (context) {
...
Drupal.behaviors.stylestrap_login_modal = {
  attach:function (context) {
    if (Drupal.settings.stylestrap_login_modal) {
...
Drupal.behaviors.stylestrap_forms_modal = {
  attach:function (context) {
    if (Drupal.settings.stylestrap_forms_modal) {
      for (var id in Drupal.settings.stylestrap_forms_modal) {
        var path = "[href*='" + Drupal.settings.stylestrap_forms_modal[id] + "']";
...
Drupal.behaviors.stylestrap_form_inline = {
  attach:function (context) {
...
Drupal.behaviors.stylestrap_menus = {
  attach:function (context) {
...
Drupal.behaviors.stylestrap_jthemes_override = {
  attach:function (context) {
